...
public class VideoTest {
    ...
    public void videoScaleTest() {
        String inputPath = "/Users/Filipp/Documents/VideoTest/2222.mp4";
        String outPutPath = "/Users/Filipp/Documents/VideoTest/1/out.mp4";
        VideoOperation ffmpeg = VideoOperation.builder(ffmpegEXE);
        Result result = ffmpeg.videoScale(inputPath,"640","360", outPutPath);
        System.out.println(result.getCode());
        System.out.println(result.getErrMessage());
    }
